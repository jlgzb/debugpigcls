...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='mmgzb/work_dirs/pad_depthrescale_repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_diameter5/epoch_25.pth',
            prefix='backbone',
            )
    ),
    neck = dict(
...
# runtime setting
work_dir = './mmgzb/work_dirs/pad_depthscale_repvgg-D2se-gcn-gap_1xb32-sgd-aprf-30e_freeze4_diameter5'
