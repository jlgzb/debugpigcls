...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='../../checkpoints_all/mmcls/repvgg-D2se_3rdparty_4xb64-autoaug-lbs-mixup-coslr-200e_in1k_20210909-cf3139b7.pth',
            prefix='backbone',
            )
    ),
    head = dict(
...
data = dict(
    samples_per_gpu=16, # for single GPU 8xb32
    workers_per_gpu=1,
    train=dict(
        type=dataset_type,
...
# runtime setting
#work_dir = './mmgzb/work_dirs/repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_diameter5'
work_dir = './work_dirs/repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_diameter5'
