...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='mmgzb/work_dirs/pad_repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_orange21/epoch_30.pth',
            prefix='backbone',
            )
    ),
    neck = dict(
...
# runtime setting
work_dir = './mmgzb/work_dirs/pad_repvgg-D2se-gcn-gap_1xb32-adam-aprf-30e_orange21'
