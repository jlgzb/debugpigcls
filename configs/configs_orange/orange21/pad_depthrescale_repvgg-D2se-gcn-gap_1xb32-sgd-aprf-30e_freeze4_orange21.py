...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='mmgzb/work_dirs/pad_depthrescale_repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_orange21/epoch_28.pth',
            prefix='backbone',
            )
    ),
    neck = dict(
...
# dataset setting
dataset_type = 'Orange21'
images_dir = 'data/orange/colorIMG_6view'
ann_file_dir = 'data/orange/statics/ann_label21'
label_type = 'name2label'
...
# runtime setting
work_dir = './mmgzb/work_dirs/pad_depthscale_repvgg-D2se-gcn-gap_1xb32-sgd-aprf-30e_freeze4_orange21'
