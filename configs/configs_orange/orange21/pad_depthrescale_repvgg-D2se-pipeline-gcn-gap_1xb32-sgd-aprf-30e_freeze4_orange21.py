...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='mmgzb/work_dirs/pad_depthrescale_repvgg-D2se-pipeline_in1k-pre_1xb32-sgd-aprf-30e_orange21/epoch_21.pth',
            prefix='backbone',
            )
    ),
    neck = dict(
...
# runtime setting
work_dir = './mmgzb/work_dirs/pad_depthrescale_repvgg-D2se-pipeline-gcn-gap_1xb32-sgd-aprf-30e_freeze4_orange21'
