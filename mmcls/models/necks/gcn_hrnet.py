...
class unit_adjacent(nn.Module):
    def __init__(self):
        ...
        self.conv_query = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=1)
        self.conv_key = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=1)
...
class unit_gcn(nn.Module):
    def __init__(self, in_C=2048, out_C=512):
...
class UnitGCNGAPHrn(nn.Module):
    ...
    def __init__(self, dim=2):
        super(UnitGCNGAPHrn, self).__init__()
...
class UnitGCNGMPHrn(nn.Module):
    ...
    """
    def __init__(self, dim=2):
        super(UnitGCNGMPHrn, self).__init__()
        assert dim in [1, 2, 3], 'GlobalAveragePooling dim only support ' \
            f'{1, 2, 3}, get {dim} instead.'
