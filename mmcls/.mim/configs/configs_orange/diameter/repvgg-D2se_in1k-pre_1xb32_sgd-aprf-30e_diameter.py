...
data = dict(
    ...
    train=dict(
        ...
        ann_file='{}/{}_6view_train_bbox_scale.txt'.format(ann_file_dir, label_type),
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix=images_dir,
        ann_file='{}/{}_6view_val_bbox_scale.txt'.format(ann_file_dir, label_type),
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        data_prefix=images_dir,
        ann_file='{}/{}_6view_test_bbox_scale.txt'.format(ann_file_dir, label_type),
        pipeline=test_pipeline))
