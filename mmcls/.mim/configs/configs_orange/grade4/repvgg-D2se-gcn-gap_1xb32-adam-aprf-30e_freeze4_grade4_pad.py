...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='mmgzb/work_dirs/repvgg-D2se_in1k-pre_1xb32-sgd-aprf-30e_grade4/epoch_28.pth',
            prefix='backbone',
            )
    ),
    neck = dict(
...
# runtime setting
work_dir = './mmgzb/work_dirs/repvgg-D2se-gcn-gap_1xb32-adam-aprf-30e_freeze4_grade4_pad'
